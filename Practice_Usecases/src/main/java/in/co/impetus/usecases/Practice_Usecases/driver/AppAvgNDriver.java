...
import in.co.impetus.usecases.Practice_Usecases.mapper.AvgNMapper;
import in.co.impetus.usecases.Practice_Usecases.mapper.AvgNMapper.CustomCombiner;
import in.co.impetus.usecases.Practice_Usecases.reducer.AvgNReducer;
...
public class AppAvgNDriver extends MyJobConfiguration {
	...
	public static void main(String[] args) {
		...
		int exitCode = 0;
		try {
			exitCode = ToolRunner.run(configuration, new AppAvgNDriver(),
					args);
