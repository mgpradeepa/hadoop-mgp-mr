...
import in.co.impetus.usecases.Practice_Usecases.mapper.Try2TwoColumnRankingMapper;
import in.co.impetus.usecases.Practice_Usecases.partitioner.Try2TwoColumnRankingPartitioner;
import in.co.impetus.usecases.Practice_Usecases.reducer.Try2TwoColumnRankingReducer;
...
public class AppTry2TwoColumnRankingDriver extends MyJobConfiguration {
	...
	public static void main(String[] args) {
		...
		try {
			exitCode = ToolRunner.run(configuration,
					new AppTry2TwoColumnRankingDriver(), args);
	...
	private Job getJobConfig() throws Exception {
		MyJobDefinition jobDefinition = new MyJobDefinition() {
			...
			public Class<? extends Reducer> getMyReducerClass() {
				...
				return Try2TwoColumnRankingReducer.class;
			}
...
//				return Try2TwoColumnRankingPartitioner.class;
			...
			public Class<? extends Mapper> getMyMapperClass() {
				// TODO Auto-generated method stub
				return Try2TwoColumnRankingMapper.class;
			}
