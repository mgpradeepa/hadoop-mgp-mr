...
public class MovieNumberOfRatingDriver extends MyJobConfiguration {
	public static void main(String[] args) {
		...
		try {
			exitCode = ToolRunner.run(configuration,
					new MovieNumberOfRatingDriver(), args);
	...
	public int run(String[] runArgs) throws Exception {
		...
		///user/ubuntu/mgp/MovieLens/input/movies.dat,/user/ubuntu/mgp/MovieLens/input/rating/ratings.dat,/user/ubuntu/mgp/MovieLens/input/tag/tags.dat /user/ubuntu/mgp/MovieLens/output/op
		// runArgs[0] will be the class name that you would give in the cli
		String in = runArgs[0];
		String out = runArgs[1]; // /user/ubuntu/mgp/MovieLens/output/op
	...
	private Job getJobConfig() throws Exception {
		MyJobDefinition jobDefinition = new MyJobDefinition() {
			...
			public Class<? extends Reducer> getMyReducerClass() {
				...
				return MovieNumberOfRatingReducer.class;
			}
			...
			public Class<? extends Mapper> getMyMapperClass() {
				// TODO Auto-generated method stub
				return MovieNumberOfRatingMapper.class;
			}
